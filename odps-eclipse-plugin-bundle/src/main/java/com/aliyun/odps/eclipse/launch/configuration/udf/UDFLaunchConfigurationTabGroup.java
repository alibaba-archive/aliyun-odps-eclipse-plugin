...
public class UDFLaunchConfigurationTabGroup extends AbstractLaunchConfigurationTabGroup implements
  ...
  public void createTabs(ILaunchConfigurationDialog dialog, String mode) {
    ILaunchConfigurationTab[] tabs =
        new ILaunchConfigurationTab[] {new UDFClassTab(), new JavaJRETab(), new JavaClasspathTab(),
