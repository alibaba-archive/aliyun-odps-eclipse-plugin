...
public class ProjectNature implements IProjectNature {
  ...
  public static final String NATURE_ID = "com.aliyun.odps.eclipse.projectNature";

  private IProject project;

  static Logger log = Logger.getLogger(ProjectNature.class.getName());
  ...
  public void configure() throws CoreException {
    String path =
        project.getPersistentProperty(new QualifiedName(Activator.PLUGIN_ID, "ODPS.runtime.path"));
    ...
    try {
      ...
      IClasspathEntry exampleSrcEntry =
          JavaCore.newSourceEntry(exampleSrc, new IPath[] {}, exampleClasses);
