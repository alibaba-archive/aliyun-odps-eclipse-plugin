...
public class ODPSApplicationShortcut extends JavaApplicationLaunchShortcut {
  ...
  protected ILaunchConfiguration findLaunchConfiguration(IType type,
    ...
    ShotcutConfigWizard wizard =
        new ShotcutConfigWizard((IFile) resource, iConfWC, type.getFullyQualifiedName());
  ...
  protected ILaunchConfigurationType getConfigurationType() {
    return DebugPlugin.getDefault().getLaunchManager()
        .getLaunchConfigurationType(LaunchConfigurationConstants.ID_LAUNCH_CONFIGURATION_ODPS_MR);
  }
